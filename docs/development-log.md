...
> 阅读提示：第一部分是当前最新基准；第二至第四部分为历史阶段记录；第五部分记录预约功能；第六部分记录美食 JPG 图片接入与验证结果。

# 第一部分：当前最新状态（截至 2026-07-22）
...
- 横屏、定位授权、原生地图层级、`wx.openLocation`、预约弹窗、剪贴板和小屏布局仍应在微信开发者工具与真机持续回归。
